...
var responseCreator = function(param){
  if(param == 'green'){
        colorRespnose ='Green is okay';
      }else if(param == 'red'){
       colorRespnose ='I heart red';
      }else {
       colorRespnose = 'What is your favorite color?';
     }return colorRespnose;
  }
  responseCreator();
  // CODE HERE
...
function greeter(name, number){
    var name;
    var number;
    var greeting = 'Hi! My name is '+name+ ' and I am ' +number+ ' years old.';
